...
class CampaignsApi(object):
    ...
    def get_bids(self, authorization, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_bids_with_http_info(authorization, **kwargs)  # noqa: E501
            return data
    ...
    def get_bids_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        if ('authorization' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_bids`")  # noqa: E501
    ...
    def get_campaign(self, campaign_id, authorization, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_campaign_with_http_info(campaign_id, authorization, **kwargs)  # noqa: E501
            return data
    ...
    def get_campaign_with_http_info(self, campaign_id, authorization, **kwargs):  # noqa: E501
        ...
        if ('authorization' not in local_var_params or
                local_var_params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_campaign`")  # noqa: E501
    ...
    def get_categories(self, campaign_id, authorization, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_categories_with_http_info(campaign_id, authorization, **kwargs)  # noqa: E501
            return data
    ...
    def get_categories_with_http_info(self, campaign_id, authorization, **kwargs):  # noqa: E501
        ...
        if ('campaign_id' not in local_var_params or
                local_var_params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `get_categories`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in local_var_params or
                local_var_params['authorization'] is None):
    ...
    def get_category(self, campaign_id, category_hash_code, authorization, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_category_with_http_info(campaign_id, category_hash_code, authorization, **kwargs)  # noqa: E501
            return data
    ...
    def get_category_with_http_info(self, campaign_id, category_hash_code, authorization, **kwargs):  # noqa: E501
        ...
        if ('campaign_id' not in local_var_params or
                local_var_params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `get_category`")  # noqa: E501
    ...
    def update_bids(self, authorization, campaign_bid_change_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_bids(authorization, campaign_bid_change_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: JWT Bearer Token (required)
        :param list[CampaignBidChangeRequest] campaign_bid_change_request: Specifies the list of bid changes to be applied. (required)
        :return: list[CampaignMessage]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_bids_with_http_info(authorization, campaign_bid_change_request, **kwargs)  # noqa: E501
        else:
            (data) = self.update_bids_with_http_info(authorization, campaign_bid_change_request, **kwargs)  # noqa: E501
            return data

    def update_bids_with_http_info(self, authorization, campaign_bid_change_request, **kwargs):  # noqa: E501
        """Update bids for campaigns and their categories  # noqa: E501

        If a campaign bid is updated, all (if any) category bids for this campaign will be updated with the new value if they are initially equal to the campaign bid.  If the category bid is not wanted to be cascaded to the categories with the same bid value, new change bids must be added in the request for the categories where the value should be kept (with the initial value).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_bids_with_http_info(authorization, campaign_bid_change_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'campaign_bid_change_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'campaign_bid_change_request' is set
        if ('campaign_bid_change_request' not in local_var_params or
                local_var_params['campaign_bid_change_request'] is None):
            raise ValueError("Missing the required parameter `campaign_bid_change_request` when calling `update_bids`")  # noqa: E501
        ...
        body_params = None
        if 'campaign_bid_change_request' in local_var_params:
            body_params = local_var_params['campaign_bid_change_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'text/json', 'application/xml', 'text/xml', 'text/html'])  # noqa: E501
