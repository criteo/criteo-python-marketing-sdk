...
class CategoriesApi(object):
    ...
    def update_categories(self, authorization, categories_per_catalog, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_categories(authorization, categories_per_catalog, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_categories_with_http_info(authorization, categories_per_catalog, **kwargs)  # noqa: E501

    def update_categories_with_http_info(self, authorization, categories_per_catalog, **kwargs):  # noqa: E501
        """Enables/disables categories  # noqa: E501
        ...
        if ('authorization' not in local_var_params or
                local_var_params['authorization'] is None):
            raise ApiValueError("Missing the required parameter `authorization` when calling `update_categories`")  # noqa: E501
        # verify the required parameter 'categories_per_catalog' is set
        if ('categories_per_catalog' not in local_var_params or
                local_var_params['categories_per_catalog'] is None):
            raise ApiValueError("Missing the required parameter `categories_per_catalog` when calling `update_categories`")  # noqa: E501
