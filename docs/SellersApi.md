...
status = 'status_example' # str | Optional. Status of the campaign. By default, all campaigns are returned, regarless of their status. (optional)
 ...
 **status** | **str**| Optional. Status of the campaign. By default, all campaigns are returned, regarless of their status. | [optional] 
